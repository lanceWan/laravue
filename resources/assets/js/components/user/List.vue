    ...
    <div class="grid-content bg-purple-light">
        <el-row class="header">
            ...
            <el-col :span="16" class="title-action">
                <el-button type="info" icon="plus" v-if="hasPermission('role.create')" @click="$router.push('/admin/user/create')">创建用户</el-button>
            </el-col>
        </el-row>
        <el-col :span="24" class="content-wrapper">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    ...
                    <el-row>
                        <el-col :span="24">
                            <el-table :data="tableData" border v-loading="loading" element-loading-text="拼命加载中..." @sort-change="handleSortChange" @selection-change="handleSelectionChange"
                                style="width: 100%">
                                ...
                                <el-table-column fixed="right" label="操作" width="150">
                                    <template scope="scope">
                                        ...
                                        <el-button v-if="hasPermission('user.edit')" type="success" size="mini" icon="edit" @click="handleEdit('user.edit',scope.row)"></el-button>
                                        <el-button v-if="hasPermission('user.destroy')" type="danger" size="mini" icon="delete" @click="handleDestroy(scope.row.id)"></el-button>
                                    </template>
                                </el-table-column>
                            </el-table>
                        </el-col>
